...
require_once("CommentControls.php");
	...
	class Comment {
		...
		public function create() {
			...
			if($numResponses > 0) {
				$viewsRepliesText = "<span class='repliesSection viewReplies' onclick='getReplies($id, this, $videoId)'> View all $numResponses replies</span>";
			}
			else {
				$viewsRepliesText = "<div class='repliesSection'></div>";
			}
