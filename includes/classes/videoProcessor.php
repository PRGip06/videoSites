...
class videoProcessor {
	...
	private $con;
 	...
 	private $allowedTypes = array("mp4", "flv", "webm", "mkv", "vob", "ogv", "0gg", "avi", "wmv", "mov", "mpeg", "mpg");
	...
	// Insert video data into the video's table of our phpMyAdmin database

	private function insertVideoData($uploadData, $filePath) {
		$query = $this->con->prepare("INSERT INTO videos(title, uploadedBy, description, privacy, category, filePath, uploadDate) VALUES(:title, :uploadedBy, :description, :privacy, :category, :filePath, :uploadDate)");
	...
	// Convert video types to mp4 with ffmpeg tool
	...
	private function updateDuration($duration, $videoId) {
		...
		// Connect and bind data to duration in phpMyAdmin database
